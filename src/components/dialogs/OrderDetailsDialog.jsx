// src/components/orderDetailsDialog.jsx
...
import PrintableOrderToken from '../printing/PrintableOrderToken.jsx';
import ThermalPrintManager from '../printing/ThermalPrintManager.jsx'; // ONLY NEW IMPORT ADDED

const OrderDetailsDialog = ({ order, open, onClose }) => {
    const [thermalPrintOpen, setThermalPrintOpen] = useState(false); // ONLY NEW STATE ADDED
    ...
    return (
        <>
            {/* Thermal receipt printable area - UNCHANGED */}
            <div className="printable-area">
                <PrintableOrderToken order={order} />
            </div>
            ...
            <Dialog open={open} onClose={onClose} maxWidth="md" fullWidth>
                ...
                <DialogActions sx={{ p: 2, justifyContent: 'space-between' }}>
                    {/* Print button - ONLY CHANGED THE FUNCTION CALL */}
                    <Button onClick={handlePrint} color="secondary" variant="outlined" startIcon={<PrintIcon />}>
                        Print Receipt
                    </Button>
            ...
            {/* ONLY NEW COMPONENT ADDED */}
            <ThermalPrintManager
                open={thermalPrintOpen}
